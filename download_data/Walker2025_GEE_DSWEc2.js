...
var enddate = ee.Date('2020-02-28');
// ----------------------------------------------------------------------
...
var dswe_viz = {
  min:0, 
  max: 9, 
  palette: ['000000', '002ba1', '6287ec', 
            '77b800', 'c1bdb6', '000000', 
...
// DSWE monthly composite image (from image collection)
var dswe_icList=ee.ImageCollection(dswe_ic).toList(4);
print(dswe_icList);
Map.addLayer(ee.Image(ee.List(dswe_icList).get(0)), dswe_viz, 'March 17');
Map.addLayer(ee.Image(ee.List(dswe_icList).get(1)), dswe_viz, 'April 17');
Map.addLayer(ee.Image(ee.List(dswe_icList).get(2)), dswe_viz, 'May 17');
// Map.addLayer(ee.Image(ee.List(dswe_icList).get(1)), dswe_viz, 'March 17');
...
var export_label = ee.Algorithms.String('DSWEc2_')
...
//   min: 0,
//   max: 9,
//   palette: ['000000', '002ba1', '6287ec', '77b800', 'c1bdb6', '000000', '000000',
...
// print('spring');
// var clipped_ic = dswe_ic.map(function(image){return image.select('dswe').clip(aoi)});
// print(clipped_ic.getFilmstripThumbURL(filmArgs));